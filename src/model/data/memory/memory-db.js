...
/*
  An in-memory database that doesn't retain any data (only while the server is running).
  It is not to be used in production, but for testing purposes.
  Note that every call made to a database will be asynchronous!!!
*/

const validateKey = (key) => typeof key === 'string';

// all data is stored in an object
class MemoryDB {
  constructor() {
